...
<div class="container">
	...
	<tr>
		...
		<th class="text-center">Ref #&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["ref"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["ref"]; ?> text-primary"></span></a></small></th>
		<th class="text-center">Order Date&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["orderdate"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["orderdate"]; ?>  text-primary"></span></a></small></th>
		<th class="text-center">Req. Delivery Date&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["expdelivery"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["expdelivery"]; ?>  text-primary"></span></a></small></th>
		<th class="text-center">Client Name&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["clientname"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["clientname"]; ?>  text-primary"></span></a></small></th>
		<th class="text-center">Contact Name&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["contact"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["contact"]; ?>  text-primary"></span></a></small></th>
		<th class="text-center">Total Cost&nbsp;</th>
		<th class="text-center">Process Status&nbsp;<small><a href="<?php echo base_url()."admin/archive/".$sort["status"]."/".$pagestring ."/". $str_keywords ."";?>" class="sort-link"><span class="glyphicon <?php echo $css_class["status"]; ?>  text-primary"></span></a></small></th>
	...
	<tr>
		...
		<th class="text-center"><button type="button" name="Search" id="btnSearch" data-url="<?php echo base_url()?>admin/archive_search" data-view-url="<?php echo base_url()?>admin/archive" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;Search</button></th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr>
		...
		<input type="hidden" name="archive" value="<?php echo base_url(); ?>admin/unarchive_order" />
		...
		<button class="btn btn-default btn-sm btnUnArchive">Unarchive</button>
