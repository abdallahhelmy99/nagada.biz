...
<h1><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;<?php echo $heading; ?></h1>
	...
	?>
	<?php echo form_open(uri_string(), 'role="form" class="form-horizontal" id="staff_order_form"');?>
	<div class="form-group">
		<label for="client_name_ajax" class="col-sm-2 control-label">Client Name</label>
		<div class="col-sm-4">
			<input type="text" name="client_name" class="form-control input-sm typeahead" id="client_name_ajax" placeholder="Client Name" data-link="<?php echo base_url()."staff/ajax_find_client" ?>">
			<span class="help-block">Leave blank for common order form.</span>
		</div>
	</div>	
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<input type="email" name="contact_email" class="form-control input-sm" id="contact_email" placeholder="Contact Email" required="required">
		</div>
		<label for="contact_mobile" class="col-sm-2 control-label">Contact Mobile</label>
		<div class="col-sm-2">
			<input type="text" name="contact_mobile" class="form-control input-sm" id="contact_mobile" placeholder="Contact Mobile" required="required">
		</div>
	...
	<tr>
		...
		<th width="90" class="text-center">Lamination</th>
		<th width="90" class="text-center">Quality</th>
		<th width="90" class="text-center">Finishing</th>
	...
	<tr class="title_row">
		<td><strong>#</strong></td>
		<td colspan="13"><span><h5><strong><?php echo $row->template_filename; ?></strong></h5></span>
		</td>
	</tr>
	...
	<tr class="input_row">
		...
		<td>
			<span><input type="text" name="filename[]" class="form-control input-sm" value="<?php echo $row->template_filename; ?>" readonly="readonly"></span>
		</td>
		<td><span><input type="text" name="width[]" class="form-control input-sm" value="<?php echo $row->template_width; ?>" readonly="readonly"></span></td>
		<td><span><input type="text" name="height[]" class="form-control input-sm" value="<?php echo $row->template_height; ?>" readonly="readonly"></span></td>
		<td><span><input type="text" name="qty[]" class="form-control input-sm" value="<?php echo $row->template_quantity; ?>"></span></td>
		<td><span><input type="text" name="m2[]" class="form-control input-sm" value="0" readonly="readonly"></span></td>
		<td><span><?php echo form_dropdown('material[]', $options_material, $row->template_material, 'class="form-control input-sm myselect" readonly="readonly"'); ?></span></td>
		<td><span><?php echo form_dropdown('lamination[]', $options_lamination, $row->template_lamination, 'class="form-control input-sm myselect" readonly="readonly"'); ?></span></td>
		<td><span><?php echo form_dropdown('quality[]', $options_quality, $row->template_quality, 'class="form-control input-sm myselect" readonly="readonly"'); ?></span></td>
		...
		<td><span><input type="text" name="up[]" class="form-control input-sm" value="0"></span></td>
		<td><span><input type="text" name="extra[]" class="form-control input-sm" value="0"></span></td>
		<td><span><input type="text" name="total[]" class="form-control input-sm" value="0" readonly="readonly"></span></td>
		<td><span><input type="text" name="notes[]" class="form-control input-sm" value=""></span></td>
		<?php 
		/*
	...
	<tr>
		<td colspan="15">
			<button id="add_row" name="add_row" class="btn btn-primary btn-sm add_row"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;Add row</button>
		</td>
	</tr>
	/-->
	<tr>
		<td colspan="4" align="right"><strong>Total</strong></td>
		<td><div id="grand_qty"></div></td>
		<td><div id="grand_size"></div></td>
		<td colspan="6" align="right"><strong>Total Cost</strong></td>
		<td><div id="grand_cost"></div></td>
		<td colspan="2"></td>
	</tr>
	</tfoot>
	</table>
