				...
				<tbody>
					...
					?>
							<tr class="title_row">
								<td><strong>#</strong></td>
								<td colspan="13"><span>
										<h5><strong><?php echo $row->template_filename; ?></strong></h5>
									</span>
								</td>
							</tr>
						...
						?>
							...
							<tr class="input_row">
								...
								<td><span><input type="text" name="height[]" class="form-control input-sm" value="<?php echo round($row->template_width / $row->template_height, 2); ?>" readonly="readonly"></span></td>
