<div class="container">
	<div class="client_order_form">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<!-- ABDELRADY - Email & Phone Number Not Required -->
			...
			<div class="col-sm-2">
				<input type="text" name="date_delivery" class="form-control input-sm" id="date_delivery" placeholder="MM/DD/YYYY" value="<?php echo date('m/d/Y'); ?>" required>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="table-responsive">
			<table id="order_tbl" class="table-bordered table-condensed table-striped table-hover">
				...
				<tbody>
					<?php
					if (isset($filename)) {
						// ABDELRADY - Clearing extra and total and grand_cost
